...
#' @param b Numeric. Upper bound of the uniform distribution. Default is 10.
#'
#' @returns A histogram with overlaid density curves: empricial density, theoretical normal approximation,
#' and the original uniform distribution
#' @export
#'
#' @examples
